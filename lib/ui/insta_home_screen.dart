...
import 'package:tbb/ui/insta_feed_screen.dart';
import 'package:tbb/ui/insta_profile_screen.dart';
import 'package:tbb/ui/insta_search_screen.dart';
...
class _InstaHomeScreenState extends State<InstaHomeScreen> {
  ...
  final _items = [
        BottomNavigationBarItem(
          icon: Icon(Icons.content_copy, size: 28, color: Colors.black54),
          title: Text(
            'Challenges',
