...
import 'package:tbb/models/comment.dart';
import 'package:tbb/models/like.dart';
import 'package:tbb/models/message.dart';
import 'package:tbb/models/post.dart';
import 'package:tbb/models/user.dart';
import 'package:tbb/models/feed.dart';
...
class FirebaseProvider {
  ...
  Future<User> fetchUserDetailsById(String uid) async {
    ...
    print('asihofdasdasdadasdasdasdasdasdasdaas');
    return User.fromMap(_documentSnapshot.data);
  }
